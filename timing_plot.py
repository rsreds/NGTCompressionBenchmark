...
reading_timing = "../results/mc_timing_results_reading.csv"
generation_timing = "../results/timing_results_generation.csv"
...
plt.savefig("../results/plots/mc_reading_timing.png")
...
p = np.polyfit(x, y, 1)
ax.plot(x, p[0] * x + p[1], color=colors[1], linestyle='--', label='RNTuple fit')
plt.savefig("../results/plots/mc_generation_timing.png")
