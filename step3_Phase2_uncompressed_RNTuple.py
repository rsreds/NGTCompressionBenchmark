...
if len(sys.argv) < 2:
    raise RuntimeError("Usage: cmsRun step3_Phase2_uncompressed_RNTuple.py <num_events>")
...
process.RAWRNTupleoutput = cms.OutputModule("RNTupleOutputModule",
    ...
    fileName = cms.untracked.string(f'file:../store/uncompressed/mc_Phase2_RNTuple_{num_events}.root'),
)
