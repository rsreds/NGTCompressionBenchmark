...
# with command line options: step4 -s RAW2DIGI,L1Reco,RECO --conditions auto:phase1_2025_realistic --datatier GEN-SIM-RECO -n 1000 --eventcontent RECO --geometry DB:Extended --era Run3_2025 --filein file:step3.root --fileout file:step4.root
...
if len(sys.argv) < 5:
    raise RuntimeError("Usage: cmsRun step2_compression_test.py <compression> <level> <num_events> <oupuf_file>")
...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    compressionAlgorithm = cms.untracked.string(compression),
    compressionLevel = cms.untracked.int32(level),
